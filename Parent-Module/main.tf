...
module "virtual_network" {
  ...
  virtual_network_name     = "vnet-infra-app"
...
module "public_ip_frontend" {
  ...
  public_ip_name      = "pip-infra-app-frontend"
  resource_group_name = "infra-app"
...
module "frontend_vm" {
  ...
  frontend_ip_name     = "pip-infra-app-frontend"
  vnet_name            = "vnet-infra-app"
  frontend_subnet_name = "frontend-subnet"
  key_vault_name       = "infra-app-vault"
...
#   source              = "../modules/azurerm_public_ip"
#   public_ip_name      = "pip-infra-app-backend"
#   resource_group_name = "infra-app"
#   location            = "centralindia"
#   allocation_method   = "Static"
# }
...
#   virtual_network_name = "vnet-infra-app"
#   subnet_name          = "backend-subnet"
#   pip_name             = "pip-infra-app-backend"
# }
